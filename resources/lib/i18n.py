...
TRANSLATIONS = {
    ...
    'tv_shows': {'nl': "TV-programma's", 'en': 'TV Shows'},
    'documentary': {'nl': 'Documentaire', 'en': 'Documentary'},
    'movies': {'nl': 'Films', 'en': 'Movies'},
    'channels': {'nl': 'Kanalen', 'en': 'Channels'},
    'episodes': {'nl': 'Afleveringen', 'en': 'Episodes'},
    'episode': {'nl': 'Aflevering', 'en': 'Episode'},
    'other': {'nl': 'Overig', 'en': 'Other'},
    'result': {'nl': 'Resultaat', 'en': 'Result'},
    'search_title': {'nl': 'Zoeken NLZiet', 'en': 'Search NLZiet'},
    'found_count': {'nl': '{} gevonden', 'en': '{} found'},
    'missing_search_query': {'nl': 'Zoekopdracht ontbreekt', 'en': 'Missing search query'},
